...
class ClassifierModel:
    ...
    def __init__(self, batch_size=1, win_size=10, filename="",
        ...
        self.cross_entropy_wave = tf.nn.softmax_cross_entropy_with_logits(labels=self.pnt_y_ph,
                                                                          logits=self.execute_wave())
    ...
    def wave_model(self, seq_length, pnt_ph, train_ph, prompts_ph,
        ...
        def convolve_data_3layer_pnt(input_data, variables, n, dtype):
            ...
            def gen_convolved_output(sequence, W, b, stride, num_hidden, new_size, train_ph,
                                     padding='SAME'):
            ...
            for i in range(3):
                ...
                input_data = gen_convolved_output(input_data, variables["W" + si],
                                                  ...
                                                  layer_elements[i + 1], output_sizes[i], train_ph,
                                                  padding)
